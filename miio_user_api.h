 ...
 */
static inline int miio_reboot(void)
{
 ...
 *@return   0: success, negetive value: failure
 */
static inline int miio_restore(void)
{
 ...
 */
static inline uint64_t miio_systime_get(void)
{
 ...
 *@return   0: success, negetive value: failure
 */
static inline int miio_devinfo_callback_register(mi_service_devinfo_callback_t cb)
{
